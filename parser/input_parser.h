...
#define ARG_TTL "-ttl"
#define ARG_INC "-inc"
#define ARG_F "-f"  // Hash field
#define ARG_V "-v"  // Hash value
#define ARG_N "-n"  // num

#define ARG_I "-i"  // Set Intersection
#define ARG_U "-u"  // Set Union
#define ARG_D "-d"  // Set Difference
#define ARG_S "-s"  // Set Store
#define ARG_R "-r"  // Set get Random
